...
lib/db/                 Schema and migrations (Phase 19)
lib/jobs/               The analysis job store (Phases 16, 19)
...
| `lib/db` | Schema, migrations, connection | Know what an analysis is |
...
| `lib/share` | What the share card says | Restate the report |
